    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list" id="sidebar">
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <a class="nav-link static-item disabled" ____________________________="" href="https://cinenowapp.com/#">
          
                <span class="default-icon">Movie Collection</span>
                <span class="mini-icon">-</span>
            
                    </a>
                </li>
               <li class="nav-item">
                <a class="nav-link" ____________________________="" href="{{ route('backend.movie-collection') }}">
                <i class="icon ph ph-film-slate" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Movie Collections" data-bs-original-title="Movie Collections">
                    
                </i><span class="item-name">Movie Collections</span><i class="icon "></i>
                    </a>
                </li>
              @php
