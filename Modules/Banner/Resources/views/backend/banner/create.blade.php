        ...
        <div class="card-body">
            <div class="row gy-3">
                ...
                <div class="row gy-3">
                    ...
                    <div class="col-md-4 col-lg-4 mt-3">
                        <div class="position-relative">
                            {{ html()->label(__('banner.lbl_trailer_video'), 'video_trailer_url')->class('form-label') }}
                    
                            {{ html()->text('video_trailer_url')
                                ->class('form-control')
                                ->placeholder('Enter trailer video URL (e.g. https://youtu.be/xyz123)')
                                ->value(old('video_trailer_url', isset($data) ? $data->video_trailer_url : '')) }}
                    
                            <div class="uploaded-video mt-2">
                                @if(!empty(old('video_trailer_url', isset($data) ? $data->video_trailer_url : '')))
                                    <video 
                                        src="{{ old('video_trailer_url', isset($data) ? $data->video_trailer_url : '') }}" 
                                        controls width="200">
                                    </video>
                                @endif
                            </div>
                            ...
                            <small class="text-muted d-block mt-1">
                                Example: https://cdn.yoursite.com/trailers/video.mp4 or YouTube/Vimeo link.
                            </small>
                        </div>
                    </div>
